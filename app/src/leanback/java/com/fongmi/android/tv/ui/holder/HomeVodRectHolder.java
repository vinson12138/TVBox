...
public class HomeVodRectHolder extends BaseVodHolder {

    private final VodPresenter.OnClickListener listener;
    private final AdapterHomeVodRectBinding binding;

    public HomeVodRectHolder(@NonNull AdapterHomeVodRectBinding binding, VodPresenter.OnClickListener listener) {
        super(binding.getRoot());
        this.binding = binding;
        this.listener = listener;
    }

    public HomeVodRectHolder size(int[] size) {
    ...
    public void initView(Vod item) {
        ...
        binding.score.setVisibility(TextUtils.isEmpty(score) ? View.GONE : View.VISIBLE);
